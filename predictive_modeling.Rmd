...
Our model has an RMSE an RMSE of 110 on the testing data and an RMSE of 98.6 crimes on the full dataset
...
The only variables with explanatory power is Percent of population 25 years or older with a bachelor's degree, Percent of population that identifies having two or more races, and Tract population in 2010. In total, the model with selected variables have an RMSE of 110 on the testing data and an RMSE of 149 on the full dataset.
...
ggplot() +
  ...
  theme_minimal() +
  labs(
    title = "PC1 And PC2 Captures Clear Relationships Across Years",
  )
