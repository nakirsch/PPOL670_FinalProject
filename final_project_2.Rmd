...
database. From this database, we gathered DC crime data from 2010-2022 which
...
incidents reported from 2019 - 2022, and crime_data_2010s, which includes DC crime
incidents reported from 2010 - 2019.
...
crimerate_map <- ggplot() +
  ...
  labs(title = "Crime rate in census tracts by year",
       fill = "Crime Rate",
       caption = "Open Data DC. Updated 2021. Census Tracts in 2010. & Open Data DC. Crime Incidents in years 2019 to 2022.") +
  theme_void()
...
crime_police21 <- ggplot() +
  ...
  labs(
    ...
    caption = "Open Data DC. Updated 2021. Census Tracts in 2010; Open Data DC. Crime Incidents in years 2019 to 2022; Open Data DC. Updated 2021. Police Stations."
  ) +
  theme_void()
```
