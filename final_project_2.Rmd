...
This project uses data from Open Data DC on crime incidents in DC from 2010 to 2022, as well as demographic data from the Census's 5-year surveys, to study how DC's crime rates and types of crime have changed over the course of the COVID-19 pandemic and over the ten years leading up to the pandemic. In this analysis, we first explore DC's crime counts and rates through data visualization, then use [machine learning technique] to predict [fill in].
...
pop_map <- ggplot() +
  ...
  scale_fill_gradient(low = "blue",
                      high = "red") +
  labs(title = "DC population is highly concentrated in a few tracts",
       caption = "DC Tract data obtained from the American Community Survey 5-year estimates") +
  theme_void()
...
crimerate_map <- ggplot() +
  ...
  facet_wrap(~year) +
  labs(title = "Crime rates distributions across tracts have remained consistent between 2019 - 2022",
       caption = "DC Crime Incident data reported to DC MPD") +
  theme_void()
...
crime_police21 <- ggplot() +
  ...
  labs(title = "Most crimes were concentrated around police stations in 2021",
       caption = "DC Crime Incident and Police Station data reported to DC MPD") +
  theme_void()
